...
package org.tensorflow.lite.examples.firsteye
...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        val modelName = "wv_k_8_c_5_80_small.tflite"
        //val modelName = "wv_quality_mcunet-320kb-1mb_vww.tflite"
    ...
    fun classify(image: Bitmap, rotation: Int) {
        ...
        val imageProcessor =
            ImageProcessor.Builder()
                .add(ResizeOp(80, 80, ResizeOp.ResizeMethod.BILINEAR))  // 👈 resize to 80x80
                .build()
